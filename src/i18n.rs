...
fn en_us(key: I18nKey) -> &'static str {
    match key {
        ...
        I18nKey::HintSpace => "Enter clears selected space",
...
fn zh_cn(key: I18nKey) -> Option<&'static str> {
    Some(match key {
        ...
        I18nKey::HintSpace => "Enter 清空已选空间",
